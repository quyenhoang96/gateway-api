...
func (in *CustomGRPCRoute) DeepCopyInto(out *CustomGRPCRoute) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
func (in *CustomGRPCRoute) DeepCopy() *CustomGRPCRoute {
	if in == nil {
		return nil
	}
	out := new(CustomGRPCRoute)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomGRPCRoute) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *CustomGRPCRouteList) DeepCopyInto(out *CustomGRPCRouteList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]CustomGRPCRoute, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CustomGRPCRouteList) DeepCopy() *CustomGRPCRouteList {
	if in == nil {
		return nil
	}
	out := new(CustomGRPCRouteList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomGRPCRouteList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
